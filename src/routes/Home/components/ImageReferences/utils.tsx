import { Square, Circle, AArrowUpIcon } from "lucide-react";
...
export const icons: { [key: string]: { full: JSX.Element; empty: JSX.Element } } = {
  ...
  path: {
    full: <AArrowUpIcon className="h-5 w-5 fill-current text-gray-600" />,
    empty: <AArrowUpIcon className="h-5 w-5 text-gray-600" />,
  },
  text: {
    full: <AArrowUpIcon className="h-5 w-5 text-gray-600" />,
    empty: <AArrowUpIcon className="h-5 w-5 text-gray-600" />,
  },
  rhombus: {
    full: (
